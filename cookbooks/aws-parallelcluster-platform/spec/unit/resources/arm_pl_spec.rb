...
describe 'arm_pl:setup' do
  for_all_oses do |platform, version|
    context "on #{platform}#{version} x86" do
      ...
      cached(:armpl_url) { "https://bucket.s3.#{aws_domain}/archives/armpl/#{armpl_platform}/#{armpl_tarball_name}" }
      ...
      cached(:gcc_url) { "https://bucket.s3.#{aws_domain}/archives/dependencies/gcc/gcc-#{gcc_version}.tar.gz" }
